...
SELECT name FROM country WHERE population<100000 AND continent='Europe';
SELECT population FROM country WHERE population<100000 AND continent='Europe';
...
-- She's in ___Santa Monica___________________!
